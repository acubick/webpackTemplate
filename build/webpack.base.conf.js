...
module.exports = {
    ...
    /// View console
    // sassdoc.parse(PATHS.src + '/scss').then(function(items) {
    //     console.log('sassdoc:', items);
    // })
...
//             watermark: true,
//         },
//         package: './package.json', // Defaults to `./package.json`
//         theme: 'default', // Defaults to `default`
//     }
// sassdoc.documentize(PATHS.src + '/scss', './', cfg);